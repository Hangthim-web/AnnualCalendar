        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ url('index') }}" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="{{ $getSystemLogo['favicon'] }}" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="{{ $getSystemLogo['logo'] }}P" alt="" height="20">
                    </span>
                </a>
                ...
                <a href="{{ url('index') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ $getSystemLogo['logo'] }}" alt="" height="20">
                    </span>
                </a>
            </div>
...
@endswitch
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="" class="text-reset notification-item">
                            <div class="d-flex align-items-start">
                                <div class="flex-shrink-0 me-3">
                                    <img src="{{ URL::asset('/assets/images/crs_onlylogo.jpg') }}" class="rounded-circle avatar-xs" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                ...
                <button type="button" class="btn d-flex header-item waves-effect align-items-center">
                    ...
                    @if (auth()->user()->hasRole('EMPLOYEE'))
                        ...
                        <img src="/storage/{{ getCompanyId().'/employee_images/users/'.$image }}" class="rounded-circle border-clock"
                            style="border:2px solid #a19d9d" width="35" height="35" alt="profile image">
                    @else
                    <img class=" header-profile-user"
                    src="{{ url('storage/company_images/' . getCompanyLogos()['favicon_image']) }}"
                    alt="Header Avatar">
                    @endif --}}



                    {{-- <span class="d-none d-xl-inline-block ms-1 fw-medium font-size-15 form-control">
                        {{ getFullName(Auth::user()?->id) }}
                    </span> --}}
                    {{-- <span
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('employee.profile') }}"><i
                            class="uil uil-user font-size-18 align-middle text-muted me-1"></i> <span
                    ...
                    {{-- <a class="dropdown-item" href="{{ route('logout') }}"><i
                        class="uil uil-sign-out-alt font-size-18 align-middle text-muted me-1"></i> <span
                    ...
                    <a class="dropdown-item"
                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i
                            ...
                            class="align-middle">@lang('Sign out')</span></a>
