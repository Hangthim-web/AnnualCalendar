            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        {{-- {{ getCompanyLogos()['company_logo'] }} --}}
                        {{-- <a href="{{ url('index') }}" class="mb-5 d-block auth-logo">
                            <img src="{{ url('storage/company_images/' . getCompanyLogos()['company_logo']) }}" alt="Company Logo" height="50"
                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to {{ config('constants.COMPANY_NAME') }}.
                                </p>
                            </div>
                            <div class="p-2 mt-4">
                    ...
                    <div class="mt-5 text-center">
                        <p>©
                            ...
                            </script> Designed and Developed By Prologic Solution Pvt Ltd.
                        </p>
                    </div>
